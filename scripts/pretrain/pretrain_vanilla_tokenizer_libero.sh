...
CONFIG_NAME=${3:-"vanilla"}  # Config name (default: "config")
...
# export PYTHONPATH=/cephfs/xumengdi/codes/CausalActionTokenizer:$PYTHONPATH
...
MODEL_SCRIPT="scripts/pretrain_vanilla_tokenizer.py"
